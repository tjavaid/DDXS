...
def parseOptions():
    ...
    parser.add_option('',   '--obsName2',dest='OBSNAME2',    type='string',default='',   help='Name of the observalbe, supported: "mass4l", "pT4l", "massZ2", "rapidity4l", "cosThetaStar", "nets_reco_pt30_eta4p7"')
...
if (not (observableBins[0] == '' and observableBins[len(observableBins)-1]=='')):
    print 'BINS OPTION MUST START AND END WITH A |'
observableBins.pop()
observableBins.pop(0)
print "observableBins[0]", observableBins[0]
print "observableBins[1]", observableBins[1]
bins1=len(observableBins)
print "totoal no. of bins for observable 1 are...............", bins1  #len(observableBins)
#
...
bins2=len(observableBins2)
print "totoal no. of bins for observable 2 are...............", bins2 # len(observableBins2)
...
for obsName in observables:
    ...
    elif bins1==9: obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3','SigmaBin4','SigmaBin5','SigmaBin6','SigmaBin7']
    elif bins1==8: obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3','SigmaBin4','SigmaBin5','SigmaBin6']
    #elif obsName=="massZ2": obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3','SigmaBin4','SigmaBin5','SigmaBin6']
    elif bins1==7: obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3','SigmaBin4','SigmaBin5']
    elif bins1==6: obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3','SigmaBin4']
    elif bins1==5: obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3']
    elif bins1==4: obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2']
    else : obsbins = ['SigmaBin0','SigmaBin1']
    #elif obsName=="massZ1": obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3'] # ,'SigmaBin4','SigmaBin5','SigmaBin6']
    #elif obsName=="massZ1": obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3'] # ,'SigmaBin4','SigmaBin5','SigmaBin6']
#    elif obsName=="massZ1": obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3'] # ,'SigmaBin4','SigmaBin5','SigmaBin6']
...
#    else: obsbins = ['SigmaBin0','SigmaBin1']   #,'SigmaBin2','SigmaBin3','SigmaBin4']
    ...
    for obsbin in obsbins:
        ...
        f = TFile("higgsCombine"+obsName+"_"+obsbin+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".MultiDimFit.mH125.09.root","READ")
        if (f==0): continue
        ...
        fstat = TFile("higgsCombine"+obsName+"_"+obsbin+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+"_NoSys.MultiDimFit.mH125.09.root","READ")
        if (fstat==0): continue
        ...
        latex2.DrawLatex(0.37,0.85, "#sigma_{fid.} = "+str(round(bestfit,3))+" ^{+"+str(cl68upstat)+"}_{-"+str(cl68dnstat)+"} (stat.) ^{+"+str(sysup)+"}_{-"+str(sysdn)+"} (sys.)")
	unit="GeV"
	if (obsName2=="massZ2"):
            label2 = "m(Z_{2})"
            unit2 = "GeV"
	latex2.DrawLatex(0.37,0.80, observableBins2[0]+".0 "+unit+" < "+label2+" < "+observableBins2[1]+".0 "+unit2)
        ...
        if (obsName=="mass4l"):
            if (obsbin=="SigmaBin0"):
                ...
                resultsXS['SM_125_mass4l_'+obsbin.replace('r','').replace('Bin0','')+'_genbin0'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                ...
                resultsXS['SM_125_mass4l_'+obsbin.replace('r','').replace('Bin0','')+'_genbin0_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
        #elif obsName=="pT4l":
        elif bins1==8:
            if (obsbin=="SigmaBin0"):
                #resultsXS['SM_125_'+obsName+'_genbin0'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin0'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                #resultsXS['SM_125_'+obsName+'_genbin0_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin0_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
            if (obsbin=="SigmaBin1"):
                #resultsXS['SM_125_'+obsName+'_genbin1'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin1'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                #resultsXS['SM_125_'+obsName+'_genbin1_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin1_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
            if (obsbin=="SigmaBin2"):
                #resultsXS['SM_125_'+obsName+'_genbin2'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin2'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                #resultsXS['SM_125_'+obsName+'_genbin2_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin2_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
            if (obsbin=="SigmaBin3"):
                #resultsXS['SM_125_'+obsName+'_genbin3'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin3'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                #resultsXS['SM_125_'+obsName+'_genbin3_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin3_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
            if (obsbin=="SigmaBin4"):
                #resultsXS['SM_125_'+obsName+'_genbin4'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin4'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                #resultsXS['SM_125_'+obsName+'_genbin4_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin4_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
            if (obsbin=="SigmaBin5"):
                #resultsXS['SM_125_'+obsName+'_genbin5'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin5'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                #resultsXS['SM_125_'+obsName+'_genbin5_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin5_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
            if (obsbin=="SigmaBin6"):
                #resultsXS['SM_125_'+obsName+'_genbin6'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin6'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                #resultsXS['SM_125_'+obsName+'_genbin6_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin6_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
            if (obsbin=="SigmaBin7"):
                #resultsXS['SM_125_'+obsName+'_genbin7'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin7'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
                #resultsXS['SM_125_'+obsName+'_genbin7_statOnly'] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
                resultsXS['SM_125_'+obsName+'_genbin7_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {"uncerDn": -1.0*cl68dnstat, "uncerUp": cl68upstat, "central": bestfit}
        #elif obsName=="massZ2":
        elif bins1==7:
	    if (obsbin=="SigmaBin0"):
                #resultsXS['SM_125_'+obsName+'_genbin0'] = {"uncerDn": -1.0*cl68dn, "uncerUp": cl68up, "central": bestfit}
        ...
        c.SaveAs("plots/lhscan_"+obsName+"_"+obsbin+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".pdf")
        #c.SaveAs("plots/lhscan_"+obsName+"_"+obsbin+".png")
        c.SaveAs("plots/lhscan_"+obsName+"_"+obsbin+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".png")


        if (obsName=="mass4l"):
            if (obsbin=="SigmaBin0"):
                #with open('resultsXS_LHScan_mass4l_v3.py', 'w') as f:
                with open('resultsXS_LHScan_mass4l_v3'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.py', 'w') as f:
                    f.write('resultsXS = '+str(resultsXS)+' \n')
            else:
                #with open('resultsXS_LHScan_mass4l_v2.py', 'w') as f:
                with open('resultsXS_LHScan_mass4l_v2'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.py', 'w') as f:
                    f.write('resultsXS = '+str(resultsXS)+' \n')
        else:
            #with open('resultsXS_LHScan_'+obsName+'_v3.py', 'w') as f:
            with open('resultsXS_LHScan_'+obsName+'_v3'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.py', 'w') as f:
                f.write('resultsXS = '+str(resultsXS)+' \n')
