...
def getunc(channel, List, m4l_bins, m4l_low, m4l_high, obs_reco, obs_gen, obs_bins, genbin, obs_reco2, obs_gen2, obs_bins2):    
...
####################################################    
	...
	print "cutobs_gen is...........  ", cutobs_gen
        ...
        processBin = shortname+'_'+channel+'_'+opt.OBSNAME+'_genbin'+str(genbin)+'_'+opt.OBSNAME2+'_'+obs_gen2_low+'_'+obs_gen2_high
...
for chan in chans:
    for genbin in range(len(obs_bins)-1):
        ...
        getunc(chan,List, m4l_bins, m4l_low, m4l_high, obs_reco, obs_gen, obs_bins, genbin, obs_reco2, obs_gen2, obs_bins2)   # adding second obs. 
...
os.system('cp accUnc_'+opt.OBSNAME+'.py cp accUnc_'+opt.OBSNAME+'_'+opt.OBSNAME2+'_'+obs_bins2[0]+'-'+obs_bins2[1]+'.py')
#with open('accUnc_'+opt.OBSNAME+'.py', 'w') as f:
#with open('accUnc_'+opt.OBSNAME+'_'+opt.OBSNAME2+'_'+obs_bins2[0]+'-'+obs_bins2[1]+'.py', 'w') as f:
with open('accUnc_'+opt.OBSNAME+'_vs_'+opt.OBSNAME2+'_'+obs_bins2[0]+'_'+obs_bins2[1]+'.py', 'w') as f:
