...
def parseOptions():
    ...
    parser.add_option('',   '--obsName2',dest='OBSNAME2',    type='string',default='',   help='Name of the observalbe, supported: "inclusive", "pT", "eta", "Njets"')
...
def plotXS(obsName, obs_bins, obsName2, obs_bins2):    

    #_temp = __import__('inputs_sig_'+obsName, globals(), locals(), ['acc'], -1)
    _temp = __import__('inputs_sig_'+obsName+'_vs_'+opt.OBSNAME2+'_'+obs_bins2[0]+'_'+obs_bins2[1], globals(), locals(), ['acc'], -1)
    acc = _temp.acc 
    eff = _temp.eff
    ...
    if (obsName == "mass4l"):
        ...
        #_temp = __import__('resultsXS_'+obsName+'_v3'+floatfix, globals(), locals(), ['modelNames', 'asimovDataModelName', 'resultsXS', 'modelIndUncert'], -1)
        _temp = __import__('resultsXS_'+obsName+'_v3'+floatfix+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1], globals(), locals(), ['modelNames', 'asimovDataModelName', 'resultsXS', 'modelIndUncert'], -1)
        modelNames = _temp.modelNames
        asimovDataModelName = _temp.asimovDataModelName
        modelIndUncert = _temp.modelIndUncert
        ...
        _temp = __import__('resultsXS_LHScan_'+obsName+'_v3'+floatfix+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1], globals(), locals(), ['modelNames', 'asimovDataModelName', 'resultsXS', 'modelIndUncert'], -1)
        resultsXS = _temp.resultsXS
    ...
    _temp = __import__('accUnc_'+obsName+'_vs_'+opt.OBSNAME2+'_'+obs_bins2[0]+'_'+obs_bins2[1], globals(), locals(), ['acc','pdfUncert','qcdUncert'], -1)
    ...
    for obsBin in range(nBins-1):
        ...
        for channel in ['4e','4mu','2e2mu']:
            ...
            XH_fs = higgs_xs['VBF_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['VBF_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
            ...
            XH_fs += higgs_xs['WH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['WH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
            ...
            XH_fs += higgs_xs['ZH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ZH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
            ...
            XH_fs += higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]            
            ...
            XH_qcdunc_fs = (unc_qcd_VBF*higgs_xs['VBF_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['VBF_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            XH_qcdunc_fs += (unc_qcd_WH*higgs_xs['WH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['WH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            XH_qcdunc_fs += (unc_qcd_ZH*higgs_xs['ZH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ZH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            XH_qcdunc_fs += (unc_qcd_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2                
            ...
            XH_qqpdfunc_fs = (unc_pdf_VBF*higgs_xs['VBF_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['VBF_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                              ...
                              +unc_pdf_WH*higgs_xs['WH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['WH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                              ...
                              +unc_pdf_ZH*higgs_xs['ZH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ZH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2            
            ...
            XH_unc_fs += (unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            ggH_powheg[obsBin]+=ggH_xsBR*acc['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
            ...
            ggH_minloHJ[obsBin]+=ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
            ...
            total_NNLOunc_fs_powheg_hi =  (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            ...
            total_NNLOunc_fs_powheg_lo =  (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            ...
            total_NNLOunc_fs_powheg_hi +=  (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            ...
            total_NNLOunc_fs_powheg_lo +=  (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            ...
            total_NNLOunc_fs_minloHJ_hi =  (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            ...
            total_NNLOunc_fs_minloHJ_lo =  (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            ...
            total_NNLOunc_fs_minloHJ_hi +=  (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            ...
            total_NNLOunc_fs_minloHJ_lo +=  (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            ...
            total_NNLOunc_fs_powheg_hi += (unc_qcd_ggH_hi*ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NNLOunc_fs_powheg_lo += (unc_qcd_ggH_lo*ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            if (obsName=="mass4l"):                
                total_NNLOunc_fs_minloHJ_hi += (unc_qcd_ggH_hi
                                                ...
                                                *ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
                ...
                total_NNLOunc_fs_minloHJ_hi += (qcdunc_ggH_powheg["ggH_NNLOPS_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerUp']
                                                #*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)])**2
                                                *ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
                ...
                total_NNLOunc_fs_minloHJ_lo += (qcdunc_ggH_powheg["ggH_NNLOPS_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerDn']
                                                #*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)])**2
                                                *ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NLOunc_fs_powheg_hi += (qcdunc_ggH_powheg["ggH_powheg_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerUp']
                                          #*ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)])**2
                                          *ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NLOunc_fs_powheg_lo += (qcdunc_ggH_powheg["ggH_powheg_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerDn']
                                          #*ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)])**2
                                          *ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NLOunc_fs_minloHJ_hi += (qcdunc_ggH_powheg["ggH_NNLOPS_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerUp']
                                           #*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)])**2
                                           *ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NLOunc_fs_minloHJ_lo += (qcdunc_ggH_powheg["ggH_NNLOPS_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerDn']
                                           #*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)])**2
                                           *ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            if (obsName=="mass4l"):
                ...
                obsUnc_pdf_ggH_hi = pdfunc_ggH_powheg["ggH_powheg_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerUp']
                ...
                obsUnc_pdf_ggH_lo = pdfunc_ggH_powheg["ggH_powheg_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerUp']
            ...
            total_NNLOunc_fs_powheg_hi += (obsUnc_pdf_ggH_hi*ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                           ...
                                           -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NNLOunc_fs_powheg_lo += (obsUnc_pdf_ggH_lo*ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                           #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                           -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NNLOunc_fs_minloHJ_hi += (obsUnc_pdf_ggH_hi*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                           #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                           -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NNLOunc_fs_minloHJ_lo += (obsUnc_pdf_ggH_lo*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                           #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                           -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NLOunc_fs_powheg_hi += (pdfunc_ggH_powheg["ggH_powheg_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerUp']
                                          #*ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)]
                                          *ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                          #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                          -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NLOunc_fs_powheg_lo += (pdfunc_ggH_powheg["ggH_powheg_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerDn']
                                          #*ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)]
                                          *ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                          #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                          -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NLOunc_fs_minloHJ_hi += (pdfunc_ggH_powheg["ggH_NNLOPS_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerUp']
                                          #*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)]
                                          *ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                          #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                          -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NLOunc_fs_minloHJ_lo += (pdfunc_ggH_powheg["ggH_NNLOPS_JHUgen_125_"+channel+"_"+obsName.replace('_reco','_gen')+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]['uncerDn']
                                          #*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)]
                                          *ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                          #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                          -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
        ...
        if (opt.UNBLIND):
            ...
            data[obsBin] = resultsXS[datamodel+"_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["central"]        
            #data_hi[obsBin] = resultsXS[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["uncerUp"]
            data_hi[obsBin] = resultsXS[datamodel+"_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]
            #data_lo[obsBin] = -1.0*resultsXS[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["uncerDn"]        
            data_lo[obsBin] = -1.0*resultsXS[datamodel+"_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]        
            ...
            data[obsBin] = resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["central"]        
            #data_hi[obsBin] = resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerUp"]
            data_hi[obsBin] = resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]
            #data_lo[obsBin] = -1.0*resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerDn"]
            data_lo[obsBin] = -1.0*resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]

        if (opt.UNBLIND):
            #modeldep_hi[obsBin] = modelIndUncert["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerUp"]
            modeldep_hi[obsBin] = modelIndUncert["SM_125_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]
            #modeldep_lo[obsBin] = -1.0*modelIndUncert["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerDn"] 
            modeldep_lo[obsBin] = -1.0*modelIndUncert["SM_125_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"] 
            ...
            systematics_hi[obsBin] = sqrt(max(0.0,resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]**2-resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]**2))
            ...
            systematics_lo[obsBin] = sqrt(max(0.0,resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]**2-resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]**2))
            ...
            modeldep_hi[obsBin] = modelIndUncert["AsimovData_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]
            #modeldep_lo[obsBin] = -1.0*modelIndUncert["AsimovData_"+obsName+"_genbin"+str(obsBin)]["uncerDn"] 
            modeldep_lo[obsBin] = -1.0*modelIndUncert["AsimovData_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"] 
            #systematics_hi[obsBin] = sqrt(max(0.0,resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2))
            systematics_hi[obsBin] = sqrt(max(0.0,resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]**2-resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]**2))
            #systematics_lo[obsBin] = sqrt(max(0.0,resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2))
            systematics_lo[obsBin] = sqrt(max(0.0,resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]**2-resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]**2))
            #stat_hi[obsBin] = resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]
            stat_hi[obsBin] = resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]
            #stat_lo[obsBin] = resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]
            stat_lo[obsBin] = resultsXS["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]
    ...
    if (obsName=="mass4l"):
        for channel in ['2e2mu','4mu','4e']:
            ...
            XH_fs = higgs_xs['VBF_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['VBF_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
            ...
            XH_fs += higgs_xs['WH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['WH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
            ...
            XH_fs += higgs_xs['ZH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ZH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
            ...
            XH_fs += higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
            ...
            XH_qcdunc_fs = (unc_qcd_VBF*higgs_xs['VBF_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['VBF_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            XH_qcdunc_fs += (unc_qcd_WH*higgs_xs['WH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['WH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            XH_qcdunc_fs += (unc_qcd_ZH*higgs_xs['ZH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ZH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            XH_qcdunc_fs += (unc_qcd_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2                
            XH_unc_fs += XH_qcdunc_fs
            ...
            XH_qqpdfunc_fs = (unc_pdf_VBF*higgs_xs['VBF_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['VBF_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                              ...
                              +unc_pdf_WH*higgs_xs['WH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['WH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                              ...
                              +unc_pdf_ZH*higgs_xs['ZH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ZH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2            
            XH_unc_fs += XH_qqpdfunc_fs
            ...
            XH_unc_fs += (unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0_recobin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            ggH_powheg[bin]+=ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
            #ggH_minloHJ[bin]+=ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)]            
            ggH_minloHJ[bin]+=ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]            

             # for total uncertainty, correlate br and acc uncertainties across all channels (XH+ggH)
            #total_NNLOunc_fs_powheg_hi =  (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0']))**2
            total_NNLOunc_fs_powheg_hi =  (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            #total_NNLOunc_fs_powheg_lo =  (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0']))**2
            total_NNLOunc_fs_powheg_lo =  (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            #total_NNLOunc_fs_powheg_hi +=  (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0']))**2
            total_NNLOunc_fs_powheg_hi +=  (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            #total_NNLOunc_fs_powheg_lo +=  (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0']))**2
            total_NNLOunc_fs_powheg_lo +=  (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2

            #total_NNLOunc_fs_minloHJ_hi = (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin0']))**2
            total_NNLOunc_fs_minloHJ_hi = (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            #total_NNLOunc_fs_minloHJ_lo = (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin0']))**2
            total_NNLOunc_fs_minloHJ_lo = (unc_br*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            #total_NNLOunc_fs_minloHJ_hi += (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin0']))**2
            total_NNLOunc_fs_minloHJ_hi += (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            #total_NNLOunc_fs_minloHJ_lo += (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin0']))**2
            total_NNLOunc_fs_minloHJ_lo += (unc_acc*(XH_fs+ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin0'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]))**2
            ...
            total_NNLOunc_fs_minloHJ_hi += (unc_qcd_ggH_hi*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NNLOunc_fs_minloHJ_lo += (unc_qcd_ggH_lo*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NNLOunc_fs_powheg_hi += (unc_pdf_ggH_hi*ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                           #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                           -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NNLOunc_fs_powheg_lo += (unc_pdf_ggH_lo*ggH_xsBR*acc_ggH_powheg['ggH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                           #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                           -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NNLOunc_fs_minloHJ_hi += (unc_pdf_ggH_hi*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                           #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                           -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            total_NNLOunc_fs_minloHJ_lo += (unc_pdf_ggH_lo*ggH_xsBR*acc_ggH_powheg['ggH_NNLOPS_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]
                                           #-unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)])**2
                                           -unc_pdf_ttH*higgs_xs['ttH_'+opt.THEORYMASS]*higgs4l_br[opt.THEORYMASS+'_'+channel]*acc['ttH_powheg_JHUgen_125_'+channel+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]])**2
            ...
            data[bin] = resultsXS_v2[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["central"]
            #data_hi[bin] = resultsXS_v2[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]
            data_hi[bin] = resultsXS_v2[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]
            #data_lo[bin] = -1.0*resultsXS_v2[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]
            data_lo[bin] = -1.0*resultsXS_v2[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]
            
            if (opt.UNBLIND):
                #modeldep_hi[bin] = modelIndUncert_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]
                modeldep_hi[bin] = modelIndUncert_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]
                #modeldep_lo[bin] = -1.0*modelIndUncert_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]
                modeldep_lo[bin] = -1.0*modelIndUncert_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]
                ...
                systematics_hi[bin] = sqrt(resultsXS_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]**2)
                ...
                systematics_lo[bin] = sqrt(resultsXS_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]**2)
            else:
                ...
                if (obsName=="mass4l"):
                    #modeldep_hi[bin] = modelIndUncert_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]
                    modeldep_hi[bin] = modelIndUncert_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]
                    #modeldep_lo[bin] = -1.0*modelIndUncert_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]
                    modeldep_lo[bin] = -1.0*modelIndUncert_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]
                    #systematics_hi[bin] = sqrt(resultsXS_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2)
                    systematics_hi[bin] = sqrt(resultsXS_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]**2)
                    #systematics_lo[bin] = sqrt(resultsXS_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2)
                    systematics_lo[bin] = sqrt(resultsXS_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_v2["AsimovData_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]**2)
                else:
                    #modeldep_hi[bin] = modelIndUncert_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]
                    modeldep_hi[bin] = modelIndUncert_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]
                    #modeldep_lo[bin] = -1.0*modelIndUncert_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]
                    ...
                    systematics_hi[bin] = sqrt(resultsXS_v2[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerUp"]**2)
                    ...
                    systematics_lo[bin] = sqrt(resultsXS_v2[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_v2["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]]["uncerDn"]**2)
...
# for DXS
    ...
    if (label=="inclusive"):
        ...
        dummy.GetYaxis().SetTitle("d#sigma_{fid }/d"+label+" d"+label2+" (fb/"+unit+")")
    if (obsName.startswith('njets')):
        dummy.GetYaxis().SetTitle("#sigma_{fid} (fb)")
...
#    dummy.GetYaxis().SetTitleOffset(1.1)
    ...
    else: legend . AddEntry(g_data , "Toy Data (stat. #oplus sys. unc.)         "+obs_bins2[0]+"<"+label2+"<"+obs_bins2[1], "ep")    
    ...
    c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]+'.pdf')
    #c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'.png')
    c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]+'.png')
    #c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'.root')
    c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]+'.root')
    #c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'.C')
    c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]+'.C')
    ...
    with open('table/table_'+opt.OBSNAME+'_'+obsName2+'_'+obs_bins2[0]+'_'+obs_bins2[1]+'.py', 'w') as f:
...
plotXS(opt.OBSNAME, obs_bins, opt.OBSNAME2, obs_bins2)  
