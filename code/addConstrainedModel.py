...
observableBins2 = opt.OBSBINS2
observableBins2 = observableBins2.split('|')
observableBins2.pop()
...
_temp = __import__('inputs_sig_'+obsName+'_vs_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1], globals(), locals(), ['acc','dacc','eff','deff','inc_outfrac','binfrac_outfrac','outinratio','doutinratio','inc_wrongfrac','binfrac_wrongfrac','cfactor','lambdajesup','lambdajesdn'], -1)
acc = _temp.acc
dacc = _temp.dacc
eff = _temp.eff
deff = _temp.deff
...
for fState in fStates:
    ...
    for recobin in range(len(observableBins)-1):
        ...
        fout_ggH = max(outinratio['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
        ...
        fout_VBF = max(outinratio['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
        #fout_WH = max(outinratio['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)],0.0)
        fout_WH = max(outinratio['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
        #fout_ZH = max(outinratio['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)],0.0)
        fout_ZH = max(outinratio['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
        #fout_ttH = max(outinratio['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)],0.0)
        fout_ttH = max(outinratio['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
        ...
        for genbin in range(len(observableBins)-1):
            ...
            ggHxs_allgen += higgs_xs['ggH_125.0']*higgs4l_br['125.0_'+fState]*acc['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
            ...
            VBFxs_allgen += higgs_xs['VBF_125.0']*higgs4l_br['125.0_'+fState]*acc['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
            ...
            WHxs_allgen += higgs_xs['WH_125.0']*higgs4l_br['125.0_'+fState]*acc['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
            ...
            ZHxs_allgen += higgs_xs['ZH_125.0']*higgs4l_br['125.0_'+fState]*acc['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
            ...
            ttHxs_allgen += higgs_xs['ttH_125.0']*higgs4l_br['125.0_'+fState]*acc['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
        ...
        for genbin in range(len(observableBins)-1):        
            ...
            ggHxs = higgs_xs['ggH_125.0']*higgs4l_br['125.0_'+fState]*acc['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
            ...
            VBFxs = higgs_xs['VBF_125.0']*higgs4l_br['125.0_'+fState]*acc['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
            ...
            WHxs = higgs_xs['WH_125.0']*higgs4l_br['125.0_'+fState]*acc['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
            ...
            ZHxs = higgs_xs['ZH_125.0']*higgs4l_br['125.0_'+fState]*acc['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
            ...
            ttHxs = higgs_xs['ttH_125.0']*higgs4l_br['125.0_'+fState]*acc['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
            ...
            effsm = ggHxs/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)*max(eff['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
           # #effsm = ggHxs/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)*max(eff['ggH_HRes_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)],0.0)
            ...
            effsm += VBFxs/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)*max(eff['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
            ...
            effsm += WHxs/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)*max(eff['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
            ...
            effsm += ZHxs/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)*max(eff['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
            ...
            effsm += ttHxs/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)*max(eff['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)

            #eff['SM_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)] = effsm
            eff['SM_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = effsm
            #outinratio['SM_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)] = outin_SM
            outinratio['SM_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = outin_SM
                    ...
                    for f_WH in [0.2,0.5,1.0,1.5,1.8]:
                        for f_ZH in [0.2,0.5,1.0,1.5,1.8]:
                            for f_ttH in [0.5,1.0,1.5,2.0,5.0]:
                                ...
                                tmp_eff = f_ggH*ggHxs/(f_ggH*ggHxs+f_VBF*VBFxs+f_WH*WHxs+f_ZH*ZHxs+f_ttH*ttHxs)*max(eff['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
                                ...
                                tmp_eff += f_VBF*VBFxs/(f_ggH*ggHxs+f_VBF*VBFxs+f_WH*WHxs+f_ZH*ZHxs+f_ttH*ttHxs)*max(eff['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
                                ...
                                tmp_eff += f_WH*WHxs/(f_ggH*ggHxs+f_VBF*VBFxs+f_WH*WHxs+f_ZH*ZHxs+f_ttH*ttHxs)*max(eff['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
                                ...
                                tmp_eff += f_ZH*ZHxs/(f_ggH*ggHxs+f_VBF*VBFxs+f_WH*WHxs+f_ZH*ZHxs+f_ttH*ttHxs)*max(eff['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
                                ...
                                tmp_eff += f_ttH*ttHxs/(f_ggH*ggHxs+f_VBF*VBFxs+f_WH*WHxs+f_ZH*ZHxs+f_ttH*ttHxs)*max(eff['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]],0.0)
            ...
            eff['SMup_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = effUp
            #eff['SMdn_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)] = effDn
            eff['SMdn_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = effDn
            #outinratio['SMup_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)] = outinUp
            outinratio['SMup_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = outinUp
            #outinratio['SMdn_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)] = outinDn
            outinratio['SMdn_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = outinDn
    ...
    for recobin in range(len(observableBins)-1):
        ...
        jesSM = ggHxs*(1.0+lambdajesup['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)
        ...
        jesSM += VBFxs*(1.0+lambdajesup['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)
        ...
        jesSM += WHxs*(1.0+lambdajesup['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)
        ...
        jesSM += ZHxs*(1.0+lambdajesup['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)
        ...
        jesSM += ttHxs*(1.0+lambdajesup['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(ggHxs+VBFxs+WHxs+ZHxs+ttHxs)            
        jesSM = jesSM-1.0
        #lambdajesup['SM_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)] = jesSM
        lambdajesup['SM_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = jesSM
        ...
        jesSMup = upfactors_diag['ggH']*ggHxs*(1.0+lambdajesup['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(upfactors_diag['ggH']*ggHxs+upfactors_diag['VBF']*VBFxs+upfactors_diag['WH']*WHxs+upfactors_diag['ZH']*ZHxs+upfactors_diag['ttH']*ttHxs)
       # #jesSMup = upfactors_diag['ggH']*ggHxs*(1.0+lambdajesup['ggH_HRes_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)])/(upfactors_diag['ggH']*ggHxs+upfactors_diag['VBF']*VBFxs+upfactors_diag['WH']*WHxs+upfactors_diag['ZH']*ZHxs+upfactors_diag['ttH']*ttHxs)
        ...
        jesSMup += upfactors_diag['VBF']*VBFxs*(1.0+lambdajesup['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(upfactors_diag['ggH']*ggHxs+upfactors_diag['VBF']*VBFxs+upfactors_diag['WH']*WHxs+upfactors_diag['ZH']*ZHxs+upfactors_diag['ttH']*ttHxs)
        ...
        jesSMup += upfactors_diag['WH']*WHxs*(1.0+lambdajesup['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(upfactors_diag['ggH']*ggHxs+upfactors_diag['VBF']*VBFxs+upfactors_diag['WH']*WHxs+upfactors_diag['ZH']*ZHxs+upfactors_diag['ttH']*ttHxs)
        ...
        jesSMup += upfactors_diag['ZH']*ZHxs*(1.0+lambdajesup['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(upfactors_diag['ggH']*ggHxs+upfactors_diag['VBF']*VBFxs+upfactors_diag['WH']*WHxs+upfactors_diag['ZH']*ZHxs+upfactors_diag['ttH']*ttHxs)
        ...
        jesSMup += upfactors_diag['ttH']*ttHxs*(1.0+lambdajesup['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(upfactors_diag['ggH']*ggHxs+upfactors_diag['VBF']*VBFxs+upfactors_diag['WH']*WHxs+upfactors_diag['ZH']*ZHxs+upfactors_diag['ttH']*ttHxs)            
        jesSMup = jesSMup-1.0
        #lambdajesup['SMup_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)] = jesSMup
        lambdajesup['SMup_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = jesSMup
     ...
     #   jesSMdn = dnfactors_diag['ggH']*ggHxs*(1.0+lambdajesup['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)])/(dnfactors_diag['ggH']*ggHxs+dnfactors_diag['VBF']*VBFxs+dnfactors_diag['WH']*WHxs+dnfactors_diag['ZH']*ZHxs+dnfactors_diag['ttH']*ttHxs)
        jesSMdn = dnfactors_diag['ggH']*ggHxs*(1.0+lambdajesup['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(dnfactors_diag['ggH']*ggHxs+dnfactors_diag['VBF']*VBFxs+dnfactors_diag['WH']*WHxs+dnfactors_diag['ZH']*ZHxs+dnfactors_diag['ttH']*ttHxs)
        ...
        jesSMdn += dnfactors_diag['VBF']*VBFxs*(1.0+lambdajesup['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(dnfactors_diag['ggH']*ggHxs+dnfactors_diag['VBF']*VBFxs+dnfactors_diag['WH']*WHxs+dnfactors_diag['ZH']*ZHxs+dnfactors_diag['ttH']*ttHxs)
        ...
        jesSMdn += dnfactors_diag['WH']*WHxs*(1.0+lambdajesup['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(dnfactors_diag['ggH']*ggHxs+dnfactors_diag['VBF']*VBFxs+dnfactors_diag['WH']*WHxs+dnfactors_diag['ZH']*ZHxs+dnfactors_diag['ttH']*ttHxs)
        ...
        jesSMdn += dnfactors_diag['ZH']*ZHxs*(1.0+lambdajesup['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(dnfactors_diag['ggH']*ggHxs+dnfactors_diag['VBF']*VBFxs+dnfactors_diag['WH']*WHxs+dnfactors_diag['ZH']*ZHxs+dnfactors_diag['ttH']*ttHxs)
        ...
        jesSMdn += dnfactors_diag['ttH']*ttHxs*(1.0+lambdajesup['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]])/(dnfactors_diag['ggH']*ggHxs+dnfactors_diag['VBF']*VBFxs+dnfactors_diag['WH']*WHxs+dnfactors_diag['ZH']*ZHxs+dnfactors_diag['ttH']*ttHxs)            
        jesSMdn = jesSMdn-1.0
        #lambdajesup['SMdn_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)] = jesSMdn
        lambdajesup['SMdn_125_'+fState+'_'+obsName+'_genbin'+str(recobin)+'_recobin'+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = jesSMdn
...
os.system('cp datacardInputs/inputs_sig_'+opt.OBSNAME+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.py datacardInputs/inputs_sig_'+opt.OBSNAME+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_ORIG.py')

#with open('datacardInputs/inputs_sig_'+opt.OBSNAME+'.py', 'w') as f:
with open('datacardInputs/inputs_sig_'+opt.OBSNAME+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.py', 'w') as f:
    f.write('acc = '+str(acc)+' \n')
