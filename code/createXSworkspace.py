...
def createXSworkspace(obsName, channel, nBins, obsBin, observableBins, usecfactor, addfakeH, modelName, physicalModel, obsName2, observableBins2):
...
# for second observable
    obsBin_low2 = observableBins2[0]
    obsBin_high2 = observableBins2[0+1]

    obs_bin_lowest2 = observableBins2[0]
    obs_bin_highest2 = observableBins2[1]
    ...
    if (usecfactor):
        ...
        _temp = __import__('inputs_sig_'+obsName+'_vs_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2, globals(), locals(), ['cfactor','inc_wrongfrac','binfrac_wrongfrac','inc_outfrac','binfrac_outfrac','lambdajesup','lambdajesdn'], -1)
        ...
        _temp = __import__('inputs_sig_'+obsName+'_vs_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2, globals(), locals(), ['acc','eff','inc_wrongfrac','binfrac_wrongfrac','outinratio','lambdajesup','lambdajesdn'], -1)
        acc = _temp.acc
        eff = _temp.eff
    ...
    #from inputs_bkg_{obsName} import fractionsBackground                                        # needs to be renamed with obs2 bin, once background temp. are produced
#    _temp = __import__('inputs_bkg_'+obsName, globals(), locals(), ['fractionsBackground'], -1)



    _temp = __import__('inputs_bkg_'+obsName+'_vs_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2, globals(), locals(), ['fractionsBackground'], -1)
...
#    lumi = RooRealVar("lumi_13","lumi_13", 58.8)
    ...
    if (addfakeH):
        ...
        inc_wrongfrac_ggH=inc_wrongfrac["ggH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
        ...
        inc_wrongfrac_qqH=inc_wrongfrac["VBF_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
        #inc_wrongfrac_WH=inc_wrongfrac["WH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin]
        inc_wrongfrac_WH=inc_wrongfrac["WH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
        #inc_wrongfrac_ZH=inc_wrongfrac["ZH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin]
        inc_wrongfrac_ZH=inc_wrongfrac["ZH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
        #inc_wrongfrac_ttH=inc_wrongfrac["ttH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin]
        inc_wrongfrac_ttH=inc_wrongfrac["ttH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
    else:
    ...
    binfrac_wrongfrac_ggH=binfrac_wrongfrac["ggH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
    ...
    binfrac_wrongfrac_qqH=binfrac_wrongfrac["VBF_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
    #binfrac_wrongfrac_WH=binfrac_wrongfrac["WH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin]
    binfrac_wrongfrac_WH=binfrac_wrongfrac["WH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
    #binfrac_wrongfrac_ZH=binfrac_wrongfrac["ZH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin]
    binfrac_wrongfrac_ZH=binfrac_wrongfrac["ZH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
    #binfrac_wrongfrac_ttH=binfrac_wrongfrac["ttH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin]
    binfrac_wrongfrac_ttH=binfrac_wrongfrac["ttH_powheg_JHUgen_125_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
    ...
    for genbin in range(nBins-1):
        ...
        if (usecfactor): fideff[genbin] = cfactor[modelName+"_"+channel+"_"+obsName+"_genbin"+str(genbin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
        #else: fideff[genbin] = eff[modelName+"_"+channel+"_"+obsName+"_genbin"+str(genbin)+"_"+recobin]
        else: fideff[genbin] = eff[modelName+"_"+channel+"_"+obsName+"_genbin"+str(genbin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
    ...
    for genbin in range(nBins-1):
        if (physicalModel=="v3"):
            ...
            for fState in ['4e','4mu', '2e2mu']:
                ...
                fidxs[fState] += higgs_xs['ggH_125.0']*higgs4l_br['125.0_'+fState]*acc['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
                ...
                fidxs[fState] += higgs_xs['VBF_125.0']*higgs4l_br['125.0_'+fState]*acc['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
                ...
                fidxs[fState] += higgs_xs['WH_125.0']*higgs4l_br['125.0_'+fState]*acc['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
                ...
                fidxs[fState] += higgs_xs['ZH_125.0']*higgs4l_br['125.0_'+fState]*acc['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
                ...
                fidxs[fState] += higgs_xs['ttH_125.0']*higgs4l_br['125.0_'+fState]*acc['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]        
    ...
    outin = outinratio[modelName+"_"+channel+"_"+obsName+"_genbin"+str(obsBin)+"_"+recobin+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2]
...
#    zjetsTemplatePdf.SetName("bkg_zjets");
    ...
    template_qqzzName = "./templates/templatesXS/DTreeXS_"+obsName+"/13TeV/XSBackground_qqZZ_"+channel+"_"+obsName+"_"+obsBin_low+"_"+obsBin_high+"_"+obsName2+"_"+obsBin_low2+"_"+obsBin_high2+".root"
    ...
    template_ggzzName = "./templates/templatesXS/DTreeXS_"+obsName+"/13TeV/XSBackground_ggZZ_"+channel+"_"+obsName+"_"+obsBin_low+"_"+obsBin_high+"_"+obsName2+"_"+obsBin_low2+"_"+obsBin_high2+".root"
    if (not obsName=="mass4l"):
        ...
        template_zjetsName = "./templates/templatesXS/DTreeXS_"+obsName+"/13TeV/XSBackground_ZJetsCR_AllChans_"+obsName+"_"+obsBin_low+"_"+obsBin_high+"_"+obsName2+"_"+obsBin_low2+"_"+obsBin_high2+".root"
    else:
        ...
        template_zjetsName = "./templates/templatesXS/DTreeXS_"+obsName+"/13TeV/XSBackground_ZJetsCR_"+channel+"_"+obsName+"_"+obsBin_low+"_"+obsBin_high+"_"+obsName2+"_"+obsBin_low2+"_"+obsBin_high2+".root"
    ...
    if (addfakeH):
        if (usecfactor):
            ...
            fout = TFile("xs_125.0/hzz4l_"+channel+"S_13TeV_xs_"+modelName+"_"+obsName+"_"+physicalModel+".Databin"+str(obsBin)+".Cfactor"+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2+".root","RECREATE")
        else:
            #fout = TFile("xs_125.0/hzz4l_"+channel+"S_13TeV_xs_"+modelName+"_"+obsName+"_"+physicalModel+".Databin"+str(obsBin)+".root","RECREATE")
            fout = TFile("xs_125.0/hzz4l_"+channel+"S_13TeV_xs_"+modelName+"_"+obsName+"_"+physicalModel+".Databin"+str(obsBin)+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2+".root","RECREATE")
    else:
        if (usecfactor):
            ...
            fout = TFile("xs_125.0/hzz4l_"+channel+"S_13TeV_xs_"+modelName+"_"+obsName+"_"+physicalModel+".Databin"+str(obsBin)+".Cfactor.NoFakeH"+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2+".root","RECREATE")
        else:
            ...
            fout = TFile("xs_125.0/hzz4l_"+channel+"S_13TeV_xs_"+modelName+"_"+obsName+"_"+physicalModel+".Databin"+str(obsBin)+'_'+obsName2+'_'+obsBin_low2+'_'+obsBin_high2+".NoFakeH.root","RECREATE")
