...
def parseOptions():
    ...
    parser.add_option('',   '--obsName2',  dest='OBSNAME2',  type='string',default='',   help='Name of the observable, supported: "inclusive", "pT4l", "eta4l", "massZ2", "nJets"') 
...
global opt, args, runAllSteps
parseOptions()
observableBins2 = opt.OBSBINS2.split("|")
if (not (observableBins2[0] == '' and observableBins2[len(observableBins2)-1]=='')):
    print 'BINS OPTION MUST START AND END WITH A |'
observableBins2.pop()
observableBins2.pop(0)
print "observableBins2[0]", observableBins2[0]
print "observableBins2[1]", observableBins2[1]
...
def extractBackgroundTemplatesAndFractions(obsName, observableBins, obsName2, observableBins2):  # for DXS
    global opt
    ...
    if os.path.isfile('datacardInputs/inputs_bkg_'+{0:'',1:'z4l_'}[int(opt.doZ4l)]+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.py'):
        ...
        _temp = __import__('inputs_bkg_'+{0:'',1:'z4l_'}[int(opt.doZ4l)]+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1], globals(), locals(), ['observableBins','fractionsBackground','lambdajesupBkg','lambdajesdnBkg'], -1)
...
#            tmpSrcDir = '/raid/raid7/lucien/Higgs/HZZ4l/NTuple/ZPlusX/ZXCR/SkimTree_ZX_Run2018Data_190221/'  #Lucien
        ...
        cmd = './main_fiducialXSTemplates '+bkg_samples_shorttags[sample_tag]+' "'+tmpSrcDir+'/'+background_samples[sample_tag]+'" '+bkg_samples_fStates[sample_tag]+' '+tmpObsName+' "'+opt.OBSBINS+'" "'+opt.OBSBINS+'" '+tmpObsName2+' "'+opt.OBSBINS2+'" "'+opt.OBSBINS2+'" 13TeV templatesXS DTreeXS ' + fitTypeZ4l+ ' 0'
        print cmd
        output = processCmd(cmd)
        print output
    ...
    with open('datacardInputs/inputs_bkg_'+{0:'',1:'z4l_'}[int(opt.doZ4l)]+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.py', 'w') as f:
...
def produceDatacards(obsName, observableBins, modelName, physicalModel, obsName2, observableBins2):
    ...
    for fState in fStates:
        if (not obsName.startswith("mass4l")):
            for obsBin in range(nBins-1):
                ...
                ndata = createXSworkspace(obsName,fState, nBins, obsBin, observableBins, False, True, modelName, physicalModel,obsName2, observableBins2)
		if ((nBins-1)==8):
                    ...
                    os.system("cp xs_125.0_8bins/hzz4l_"+fState+"S_13TeV_xs_bin"+str(obsBin)+".txt xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")
                if ((nBins-1)==7):
                    ...
                    os.system("cp xs_125.0_7bins/hzz4l_"+fState+"S_13TeV_xs_bin"+str(obsBin)+".txt xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")
                if ((nBins-1)==6):
                    ...
                    os.system("cp xs_125.0_6bins/hzz4l_"+fState+"S_13TeV_xs_bin"+str(obsBin)+".txt xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")
                ...
                if ((nBins-1)==5):
                    ...
                    os.system("cp xs_125.0_5bins/hzz4l_"+fState+"S_13TeV_xs_bin"+str(obsBin)+".txt xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")
                ...
                if ((nBins-1)==4):
                    ...
                    os.system("cp xs_125.0_4bins/hzz4l_"+fState+"S_13TeV_xs_bin"+str(obsBin)+".txt xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")    

		if ((nBins-1)==3):
                    #os.system("cp xs_125.0_4bins/hzz4l_"+fState+"S_13TeV_xs_bin"+str(obsBin)+".txt xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+".txt")    
                    os.system("cp xs_125.0_3bins/hzz4l_"+fState+"S_13TeV_xs_bin"+str(obsBin)+".txt xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")
                ...
                os.system("sed -i 's~observation [0-9]*~observation "+str(ndata)+"~g' xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")
                ...
                os.system("sed -i 's~_xs.Databin"+str(obsBin)+"~_xs_"+modelName+"_"+obsName+"_"+physicalModel+".Databin"+str(obsBin)+"~g' xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")
                if ("jet" in obsName):
                    #os.system("sed -i 's~\#JES param~JES param~g' xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+".txt")
                    os.system("sed -i 's~\#JES param~JES param~g' xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")

                #os.system("sed -i 's~0.0 0.2~0.0 0.2 [-1,1]~g' xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+".txt")
                os.system("sed -i 's~0.0 0.2~0.0 0.2 [-1,1]~g' xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin"+str(obsBin)+"_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")


        else:
            #ndata = createXSworkspace(obsName,fState, nBins, 0, observableBins, False, True, modelName, physicalModel)
            ndata = createXSworkspace(obsName,fState, nBins, 0, observableBins, False, True, modelName, physicalModel,obsName2, observableBins2)
            ...
            if obsName=='mass4l': os.system("cp xs_125.0_1bin/hzz4l_"+fState+"S_13TeV_xs_inclusive_bin0.txt xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin0_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")
            ...
            if obsName=='mass4lREFIT': os.system("cp xs_125.0_1bin/hzz4l_"+fState+"S_13TeV_xs_inclusiveREFIT_bin0.txt xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin0_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")
            ...
            os.system("sed -i 's~observation [0-9]*~observation "+str(ndata)+"~g' xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin0_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")
            ...
            os.system("sed -i 's~_xs.Databin0~_xs_"+modelName+"_"+obsName+"_"+physicalModel+".Databin0~g' xs_125.0/hzz4l_"+fState+"S_13TeV_xs_"+obsName+"_bin0_"+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".txt")   
...
def createAsimov(obsName, observableBins, modelName, resultsXS, physicalModel, obsName2, observableBins2):
    ...
    for fState in fStates:
        if (nBins>1):
            ...
            for obsBin in range(nBins-1):
                ...
                cmd = cmd + 'hzz4l_'+fState+'S_13TeV_xs_'+obsName+'_bin'+str(obsBin)+'_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt '
            #cmd = cmd + '> hzz4l_'+fState+'S_13TeV_xs_'+obsName+'_bin_'+physicalModel+'.txt' 
            cmd = cmd + '> hzz4l_'+fState+'S_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt' 
            print cmd
            processCmd(cmd,1)
        else:
            ...
            cmd = 'cp hzz4l_'+fState+'S_13TeV_xs_'+obsName+'_bin0_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt hzz4l_'+fState+'S_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt'
    ...
    cmd = 'combineCards.py hzz4l_4muS_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt hzz4l_4eS_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt hzz4l_2e2muS_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt > hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt'
    print cmd 
    processCmd(cmd,1)
    if (not opt.LUMISCALE=="1.0"):
        #os.system('echo "    " >> hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'.txt')
        os.system('echo "    " >> hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt')
        #os.system('echo "lumiscale rateParam * * '+opt.LUMISCALE+'" >> hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'.txt')
        os.system('echo "lumiscale rateParam * * '+opt.LUMISCALE+'" >> hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt')
        #os.system('echo "nuisance edit freeze lumiscale" >> hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'.txt')
        os.system('echo "nuisance edit freeze lumiscale" >> hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt')
    ...
    if (physicalModel=="v2"):
        ...
        cmd = 'text2workspace.py hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt -P HiggsAnalysis.CombinedLimit.HZZ4L_Fiducial_v2:differentialFiducialV2 --PO higgsMassRange=115,135 --PO nBin='+str(nBins-1)+' -o hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.root'
        #else:
    ...
    cmd = 'cp hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.root ../'+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.root'
    print cmd 
    processCmd(cmd,1)
    ...
    _temp = __import__('inputs_sig_'+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1], globals(), locals(), ['acc'], -1)
    acc = _temp.acc
    
    # Run the Combine
    if (physicalModel=="v2"):
        #if (opt.FIXMASS=="False"):
        #cmd =  'combine -n '+obsName+' -M MultiDimFit  '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'.root -m '+opt.ASIMOVMASS+' --setPhysicsModelParameters '
        cmd =  'combine -n '+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+' -M MultiDimFit  '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.root -m '+opt.ASIMOVMASS+' --setPhysicsModelParameters '
        #else:
        #cmd =  'combine -n '+obsName+' -M MultiDimFit  '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'.root -m '+opt.ASIMOVMASS+' --PO higgsMassRange='+opt.ASIMOVMASS+','+opt.ASIMOVMASS+' --setPhysicsModelParameters '
        for fState in fStates:
            nBins = len(observableBins)
            for obsBin in range(nBins-1):
                fidxs = 0
                ...
                fidxs += higgs_xs['ggH_'+opt.ASIMOVMASS]*higgs4l_br[opt.ASIMOVMASS+'_'+fState]*acc['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                ...
                fidxs += higgs_xs['VBF_'+opt.ASIMOVMASS]*higgs4l_br[opt.ASIMOVMASS+'_'+fState]*acc['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                ...
                fidxs += higgs_xs['WH_'+opt.ASIMOVMASS]*higgs4l_br[opt.ASIMOVMASS+'_'+fState]*acc['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                ...
                fidxs += higgs_xs['ZH_'+opt.ASIMOVMASS]*higgs4l_br[opt.ASIMOVMASS+'_'+fState]*acc['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                ...
                fidxs += higgs_xs['ttH_'+opt.ASIMOVMASS]*higgs4l_br[opt.ASIMOVMASS+'_'+fState]*acc['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]
        ...
        processCmd('mv higgsCombine'+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.MultiDimFit.mH'+opt.ASIMOVMASS.rstrip('.0')+'.123456.root '+modelName+'_all_'+obsName+'_13TeV_Asimov_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.root',1)
    ...
    for fState in fStates:
        for obsBin in range(len(observableBins)-1):
            ...
            tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = parseXSResults(output,'r'+fState+'Bin'+str(obsBin)+' :')
    ...
    for obsBin in range(len(observableBins)-1):
        ...
        resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {'central':0.0, 'uncerDn':0.0, 'uncerUp':0.0}
        for fState in fStates:
            #resultsXS['AsimovData_'+obsName+'_'+fState+'_genbin'+binTag] = {'central':0.0, 'uncerDn':0.0, 'uncerUp':0.0}            
            resultsXS['AsimovData_'+obsName+'_'+fState+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {'central':0.0, 'uncerDn':0.0, 'uncerUp':0.0}            
        tmp_central = 0.0
        tmp_uncerDn = 0.0
        tmp_uncerUp = 0.0
        for fState in fStates:
            #tmp_central += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag]['central']
            tmp_central += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['central']
            #tmp_uncerDn += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag]['uncerDn']**2
            tmp_uncerDn += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn']**2
            #tmp_uncerUp += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag]['uncerUp']**2
            tmp_uncerUp += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp']**2
            ...
            resultsXS['AsimovData_'+obsName+'_'+fState+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['central'] = float("{0:.5f}".format(tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['central']))
            ...
            resultsXS['AsimovData_'+obsName+'_'+fState+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn'] = -float("{0:.5f}".format(tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn']))
            ...
            resultsXS['AsimovData_'+obsName+'_'+fState+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp'] = +float("{0:.5f}".format(tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp'])) 
        #resultsXS['AsimovData_'+obsName+'_genbin'+binTag]['central'] = float("{0:.5f}".format(tmp_central))
        resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['central'] = float("{0:.5f}".format(tmp_central))
        #resultsXS['AsimovData_'+obsName+'_genbin'+binTag]['uncerDn'] = -float("{0:.5f}".format(tmp_uncerDn**0.5))
        resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn'] = -float("{0:.5f}".format(tmp_uncerDn**0.5))
        #resultsXS['AsimovData_'+obsName+'_genbin'+binTag]['uncerUp'] = +float("{0:.5f}".format(tmp_uncerUp**0.5))
        resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp'] = +float("{0:.5f}".format(tmp_uncerUp**0.5))

    # run combine with no systematics for stat only uncertainty
    if (opt.SYS):
        cmd = cmd + ' --freezeNuisances CMS_fakeH_p1_1_8,CMS_fakeH_p1_2_8,CMS_fakeH_p1_3_8,CMS_fakeH_p3_1_8,CMS_fakeH_p3_2_8,CMS_fakeH_p3_3_8 -S 0'
        print cmd
        output = processCmd(cmd)
        for fState in fStates:
            for obsBin in range(len(observableBins)-1):
                ...
                tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = parseXSResults(output,'r'+fState+'Bin'+str(obsBin)+' :')

        # merge the results for 3 final states, for the given bins
        for obsBin in range(len(observableBins)-1):
            binTag = str(obsBin)
            #resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_statOnly'] = {'central':0.0, 'uncerDn':0.0, 'uncerUp':0.0}
            resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {'central':0.0, 'uncerDn':0.0, 'uncerUp':0.0}
            for fState in fStates:
                #resultsXS['AsimovData_'+obsName+'_'+fState+'_genbin'+binTag+'_statOnly'] = {'central':0.0, 'uncerDn':0.0, 'uncerUp':0.0}
                resultsXS['AsimovData_'+obsName+'_'+fState+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {'central':0.0, 'uncerDn':0.0, 'uncerUp':0.0}
            tmp_central = 0.0
            tmp_uncerDn = 0.0
            tmp_uncerUp = 0.0
            for fState in fStates:
                #tmp_central += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_statOnly']['central']
                tmp_central += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['central']
                #tmp_uncerDn += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_statOnly']['uncerDn']**2
                tmp_uncerDn += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn']**2
                #tmp_uncerUp += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_statOnly']['uncerUp']**2
                tmp_uncerUp += tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp']**2
                ...
                resultsXS['AsimovData_'+obsName+'_'+fState+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['central'] = float("{0:.5f}".format(tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['central']))
                ...
                resultsXS['AsimovData_'+obsName+'_'+fState+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn'] = -float("{0:.5f}".format(tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn'])) 
                ...
                resultsXS['AsimovData_'+obsName+'_'+fState+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp'] = +float("{0:.5f}".format(tmp_resultsXS[modelName+'_'+fState+'_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp']))
            #resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_statOnly']['central'] = float("{0:.5f}".format(tmp_central))
            resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['central'] = float("{0:.5f}".format(tmp_central))
            #resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_statOnly']['uncerDn'] = -float("{0:.5f}".format(tmp_uncerDn**0.5))
            resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn'] = -float("{0:.5f}".format(tmp_uncerDn**0.5))
            #resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_statOnly']['uncerUp'] = +float("{0:.5f}".format(tmp_uncerUp**0.5))
            resultsXS['AsimovData_'+obsName+'_genbin'+binTag+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp'] = +float("{0:.5f}".format(tmp_uncerUp**0.5))
...
def extractResults(obsName, observableBins, modelName, physicalModel, asimovModelName, asimovPhysicalModel, resultsXS, obsName2, observableBins2):
    # Run combineCards and text2workspace
    ...
    for fState in fStates:
        ...
        for bin in range(nBins-1):
            ...
            cmd = cmd+'hzz4l_'+fState+'S_13TeV_xs_'+obsName+'_bin'+str(bin)+'_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt '
        #cmd = cmd + '> hzz4l_'+fState+'S_13TeV_xs_'+obsName+'_bin_'+physicalModel+'.txt'
        cmd = cmd + '> hzz4l_'+fState+'S_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt'
        print cmd
        processCmd(cmd,1)
    ...
    if (physicalModel=="v3"):
        ...
        cmd = 'text2workspace.py hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.txt -P HiggsAnalysis.CombinedLimit.HZZ4L_Fiducial:differentialFiducialV3 --PO higgsMassRange=115,135 --PO nBin='+str(nBins-1)+' -o hzz4l_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.root'
        print cmd
        processCmd(cmd)
    ...
    cmd = 'root -l -b -q "addToyDataset.C(\\"'+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.root\\",\\"'+asimovModelName+'_all_'+obsName+'_13TeV_Asimov_'+asimovPhysicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.root\\",\\"toy_asimov\\",\\"'+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_exp.root\\")"'
    print cmd
    processCmd(cmd)
    ...
    if (physicalModel=="v3"):
        if (not opt.FIXFRAC):
            if (opt.FIXMASS=="False"):
                ...
                cmd =  'combine -n '+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_exp.root -m 125.0 -D toy_asimov '
            else:
                #cmd =  'combine -n '+obsName+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_exp.root -m '+opt.FIXMASS+' -D toy_asimov --setPhysicsModelParameters MH='+opt.FIXMASS  
                cmd =  'combine -n '+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_exp.root -m '+opt.FIXMASS+' -D toy_asimov --setPhysicsModelParameters MH='+opt.FIXMASS  
            ...
            if (opt.FIXMASS=="False"):
                cmd = cmd + ' -P MH'
            cmd = cmd + ' --floatOtherPOIs=1 --saveWorkspace'  # original
            ...
            if (opt.FIXMASS=="False"):
                ...
                processCmd('cp higgsCombine'+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.MultiDimFit.mH125.root '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_result.root',1)
            else:
                ...
                processCmd('cp higgsCombine'+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.MultiDimFit.mH'+opt.FIXMASS.replace('.0.root','.root')+'.root '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_result.root',1)
            cmd = cmd + ' --algo=singles --cl=0.68 --robustFit=1'
            print cmd
            output=processCmd(cmd)
            ...
            for fState in fStates:
                for obsBin in range(nBins-1):
                    ...
                    fidxs_sm += higgs_xs['ggH_125.0']*higgs4l_br['125.0_'+fState]*acc['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                    ...
                    fidxs_sm += higgs_xs['VBF_125.0']*higgs4l_br['125.0_'+fState]*acc['VBF_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                    ...
                    fidxs_sm += higgs_xs['WH_125.0']*higgs4l_br['125.0_'+fState]*acc['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                    ...
                    fidxs_sm += higgs_xs['ZH_125.0']*higgs4l_br['125.0_'+fState]*acc['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                    ...
                    fidxs_sm += higgs_xs['ttH_125.0']*higgs4l_br['125.0_'+fState]*acc['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                    fidxs = 0
                    if (not opt.FIXMASS=="False"):
                        ...
                        fidxs += higgs_xs['ggH_'+opt.FIXMASS]*higgs4l_br[opt.FIXMASS+'_'+fState]*acc['ggH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                        #fidxs += acc['ggH_HRes_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)]
                        ...
                        fidxs += higgs_xs['VBF_'+opt.FIXMASS]*higgs4l_br[opt.FIXMASS+'_'+fState]*acc['VBF_powheg_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                        ...
                        fidxs += higgs_xs['WH_'+opt.FIXMASS]*higgs4l_br[opt.FIXMASS+'_'+fState]*acc['WH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                        ...
                        fidxs += higgs_xs['ZH_'+opt.FIXMASS]*higgs4l_br[opt.FIXMASS+'_'+fState]*acc['ZH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                        ...
                        fidxs += higgs_xs['ttH_'+opt.FIXMASS]*higgs4l_br[opt.FIXMASS+'_'+fState]*acc['ttH_powheg_JHUgen_125_'+fState+'_'+obsName+'_genbin'+str(obsBin)+'_recobin'+str(obsBin)+'_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]]
                    else: fidxs = fidxs_sm
            ...
            if (opt.FIXMASS=="False"):
                ##cmd =  'combine -n '+obsName+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_exp.root -m 125.0 -D toy_asimov  --setPhysicsModelParameters '
                #cmd =  'combine -n '+obsName+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_exp.root -m 125.0 -D toy_asimov  --setPhysicsModelParameters '
                cmd =  'combine -n '+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_exp.root -m 125.0 -D toy_asimov  --setPhysicsModelParameters '
            else:
                #cmd =  'combine -n '+obsName+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_exp.root -m '+opt.FIXMASS+' -D toy_asimov --setPhysicsModelParameters MH='+opt.FIXMASS+','
                #cmd =  'combine -n '+obsName+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_exp.root -m '+opt.FIXMASS+' -D toy_asimov --setPhysicsModelParameters MH='+opt.FIXMASS+','
                cmd =  'combine -n '+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_exp.root -m '+opt.FIXMASS+' -D toy_asimov --setPhysicsModelParameters MH='+opt.FIXMASS+','
            for obsBin in range(nBins-1):
            ...
            cmd = cmd + ' --saveWorkspace --setPhysicsModelParameterRanges '
            for obsBin in range(nBins-1):
                fidxs4e = tmp_xs['4e_genbin'+str(obsBin)]
                fidxs4mu = tmp_xs['4mu_genbin'+str(obsBin)]
                fidxs2e2mu = tmp_xs['2e2mu_genbin'+str(obsBin)]
            ...
            if (opt.FIXMASS=="False"):
                ...
                processCmd('cp higgsCombine'+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.MultiDimFit.mH'+opt.FIXMASS.rstrip('.0')+'.root '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_result.root',1)
            cmd = cmd + ' --algo=singles --cl=0.68 --robustFit=1'
            print cmd
            output=processCmd(cmd)
    ...
    if (physicalModel=="v2"):
        ...
        #cmd =  'combine -n '+obsName+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_exp.root -D toy_asimov --saveWorkspace'
        cmd =  'combine -n '+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+' -M MultiDimFit '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_exp.root -D toy_asimov --saveWorkspace'
        if (not opt.FIXMASS=="False"):
        ...
        if (opt.FIXMASS=="False"):
            ##processCmd('cp higgsCombine'+obsName+'.MultiDimFit.mH125.root '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_result.root',1)
            #processCmd('cp higgsCombine'+obsName+'.MultiDimFit.mH125.root '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_result.root',1)
            processCmd('cp higgsCombine'+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.MultiDimFit.mH125.root '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_result.root',1)
        else:
            ##processCmd('cp higgsCombine'+obsName+'.MultiDimFit.mH'+opt.FIXMASS.rstrip('.0')+'.root '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_result.root',1)
            #processCmd('cp higgsCombine'+obsName+'.MultiDimFit.mH'+opt.FIXMASS.rstrip('.0')+'.root '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_result.root',1)
            processCmd('cp higgsCombine'+obsName+'_vs_'+opt.OBSNAME2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.MultiDimFit.mH'+opt.FIXMASS.rstrip('.0')+'.root '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_result.root',1)
        cmd = cmd + ' --algo=singles --cl=0.68 --robustFit=1'
        print cmd
        output=processCmd(cmd)
    ...
    for obsBin in range(len(observableBins)-1):
        if (physicalModel=="v3"):
            ...
            resultsXS[modelName+'_'+obsName+'_genbin'+str(obsBin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = parseXSResults(output,'SigmaBin'+str(obsBin)+' :')
            ...
            for fState in fStates:
                ...
                resultsXS[modelName+'_'+obsName+'_'+fState+'_genbin'+str(obsBin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = parseXSResults(output, 'r'+fState+'Bin'+str(obsBin)+' :')
    ...
    if (opt.SYS):
        ...
        cmd = cmd.replace(modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_exp.root','-d '+modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_result.root -w w --snapshotName "MultiDimFit"')
        cmd = cmd + ' --freezeNuisances CMS_fakeH_p1_1_8,CMS_fakeH_p1_2_8,CMS_fakeH_p1_3_8,CMS_fakeH_p3_1_8,CMS_fakeH_p3_2_8,CMS_fakeH_p3_3_8 -S 0'
        print cmd
        output = processCmd(cmd)
        # parse the results
        for obsBin in range(len(observableBins)-1):
            if (physicalModel=="v3"):
                ...
                resultsXS[modelName+'_'+obsName+'_genbin'+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = parseXSResults(output,'SigmaBin'+str(obsBin)+' :')
            elif (physicalModel=="v2"):
                for fState in fStates:
                    #resultsXS[modelName+'_'+obsName+'_'+fState+'_genbin'+str(obsBin)+'_statOnly'] = parseXSResults(output, 'r'+fState+'Bin'+str(obsBin)+' :')
                    resultsXS[modelName+'_'+obsName+'_'+fState+'_genbin'+str(obsBin)+'_statOnly'+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = parseXSResults(output, 'r'+fState+'Bin'+str(obsBin)+' :')
...
def addModelIndependenceUncert(obsName, observableBins, resultsXS, asimovDataModelName, physicalModel, obsName2, observableBins2):
    ...
    if (physicalModel=="v2"):
        for obsBin in range(len(observableBins)-1):
            for fState in ['4e','4mu','2e2mu']:
                ...
                modelIndependenceUncert[DataModel + obsName +'_'+fState+ '_genbin'+str(obsBin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {'uncerDn':0.0, 'uncerUp':0.0}
            ...
            for obsBin in range(len(observableBins)-1):
                for fState in ['4e','4mu','2e2mu']:
                    ...
                    if (obsName+'_'+fState+'_genbin'+binTag) in key:
                        ...
                        asimCent = resultsXS[DataModel + obsName + '_' + fState+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['central']
                        ...
                        if (diff<0) and (abs(diff) > abs(modelIndependenceUncert[DataModel + obsName + '_'+fState+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn'])):
                            #modelIndependenceUncert[DataModel + obsName + '_'+fState+'_genbin'+binTag]['uncerDn'] = float("{0:.4f}".format(diff))
                            modelIndependenceUncert[DataModel + obsName + '_'+fState+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn'] = float("{0:.4f}".format(diff))
                        #if (diff>0) and (abs(diff) > abs(modelIndependenceUncert[DataModel + obsName + '_'+fState+'_genbin'+binTag]['uncerUp'])):
                        if (diff>0) and (abs(diff) > abs(modelIndependenceUncert[DataModel + obsName + '_'+fState+'_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp'])):
                            #modelIndependenceUncert[DataModel + obsName +'_'+fState+ '_genbin'+binTag]['uncerUp'] = float("{0:.4f}".format(diff))                                                                                   
                            modelIndependenceUncert[DataModel + obsName +'_'+fState+ '_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp'] = float("{0:.4f}".format(diff))                                                                                   
    
    if (physicalModel=="v3"):
        for obsBin in range(len(observableBins)-1):
            #modelIndependenceUncert[DataModel + obsName +'_genbin'+str(obsBin)] = {'uncerDn':0.0, 'uncerUp':0.0}
            modelIndependenceUncert[DataModel + obsName +'_genbin'+str(obsBin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]] = {'uncerDn':0.0, 'uncerUp':0.0}
        ...
        for key, value in resultsXS.iteritems():
            ...
            for obsBin in range(len(observableBins)-1):
                ...
                if (obsName+'_genbin'+binTag) in key:
                    ...
                    asimCent = resultsXS[DataModel + obsName + '_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['central']
                    keyCent = resultsXS[key]['central']
                    diff = keyCent - asimCent
                    #if (diff<0) and (abs(diff) > abs(modelIndependenceUncert[DataModel + obsName + '_genbin'+binTag]['uncerDn'])):
                    if (diff<0) and (abs(diff) > abs(modelIndependenceUncert[DataModel + obsName + '_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn'])):
                        #modelIndependenceUncert[DataModel + obsName + '_genbin'+binTag]['uncerDn'] = float("{0:.4f}".format(diff))
                        modelIndependenceUncert[DataModel + obsName + '_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerDn'] = float("{0:.4f}".format(diff))
                    #if (diff>0) and (abs(diff) > abs(modelIndependenceUncert[DataModel + obsName + '_genbin'+binTag]['uncerUp'])):
                    if (diff>0) and (abs(diff) > abs(modelIndependenceUncert[DataModel + obsName + '_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp'])):
                        #modelIndependenceUncert[DataModel + obsName + '_genbin'+binTag]['uncerUp'] = float("{0:.4f}".format(diff))
                        modelIndependenceUncert[DataModel + obsName + '_genbin'+binTag+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]]['uncerUp'] = float("{0:.4f}".format(diff))
...
def runFiducialXS():
    ...
    observableBins2 = {0:(opt.OBSBINS2.split("|")[1:(len(opt.OBSBINS2.split("|"))-1)]),1:['0','inf']}[opt.OBSBINS2=='inclusive']
    print "observableBins2 is.....", observableBins2
    ### Run for the given observable
    obsName = opt.OBSNAME
    obsName2 = opt.OBSNAME2
    ...
    if (runAllSteps or opt.templatesOnly):
        extractBackgroundTemplatesAndFractions(obsName, observableBins, obsName2, observableBins2)
    ...
    if (runAllSteps):
        ...
        cmd = 'python addConstrainedModel.py -l -q -b --obsName="'+opt.OBSNAME+'" --obsBins="'+opt.OBSBINS+'" --obsName2="'+opt.OBSNAME2+'" --obsBins2="'+opt.OBSBINS2+'"'
        print cmd
        output = processCmd(cmd)
        print output
        ...
        produceDatacards(obsName, observableBins, asimovDataModelName, asimovPhysicalModel, obsName2, observableBins2)
        #resultsXS = createAsimov(obsName, observableBins, asimovDataModelName, resultsXS, asimovPhysicalModel)
        resultsXS = createAsimov(obsName, observableBins, asimovDataModelName, resultsXS, asimovPhysicalModel, obsName2, observableBins2)
        print "resultsXS: \n", resultsXS
        ...
        if (not obsName.startswith("mass4l")):
            ...
            cmd = 'python plotDifferentialBins.py -l -q -b --obsName="'+obsName+'" --obsBins="'+opt.OBSBINS+'" --obsName2="'+obsName2+'" --obsBins2="'+opt.OBSBINS2+'" --asimovModel="'+asimovDataModelName+'"'
            print cmd
    ...
    if (runAllSteps or opt.resultsOnly):
        for physicalModel in physicalModels:
            for modelName in modelNames:
                ...
                produceDatacards(obsName, observableBins, modelName, physicalModel, obsName2, observableBins2)                         
                ...
                resultsXS = extractResults(obsName, observableBins, modelName, physicalModel, asimovDataModelName, asimovPhysicalModel, resultsXS, obsName2, observableBins2)
                print "resultsXS: \n", resultsXS
                ...
                if (not obsName.startswith("mass4l")):
                    ...
                    cmd = 'python plotAsimov_simultaneous.py -l -q -b --obsName="'+obsName+'" --obsBins="'+opt.OBSBINS+'" --asimovModel="'+asimovDataModelName+'" --unfoldModel="'+modelName+'" --obsName2="'+obsName2+'" --obsBins2="'+opt.OBSBINS2+'"'# +' --lumiscale=str(opt.LUMISCALE)'
                    if (opt.UNBLIND): cmd = cmd + ' --unblind'
                    print cmd
                    output = processCmd(cmd)
                    print output                                                
                    ...
                    cmd = 'python plotAsimov_inclusive.py -l -q -b --obsName="'+obsName+'" --obsBins="'+opt.OBSBINS+'" --asimovModel="'+asimovDataModelName+'" --unfoldModel="'+modelName+'" --obsName2="'+obsName2+'" --obsBins2="'+opt.OBSBINS2+'"' #+' --lumiscale=str(opt.LUMISCALE)'            
                    if (opt.UNBLIND): cmd = cmd + ' --unblind'
                    print cmd
                    output = processCmd(cmd)
                    print output
            ...
            modelIndependenceUncert = addModelIndependenceUncert(obsName, observableBins, resultsXS, asimovDataModelName,physicalModel, obsName2, observableBins2)
            print "modelIndependenceUncert: \n", modelIndependenceUncert
            if (opt.FIXFRAC): floatfix = '_fixfrac'
            else: floatfix = ''
            #with open('resultsXS_'+obsName+'_'+physicalModel+floatfix+'.py', 'w') as f:
            with open('resultsXS_'+obsName+'_'+physicalModel+floatfix+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.py', 'w') as f:
...
#        output = processCmd(cmd)
	...
	if (obsName=="massZ1" and obsName2=="massZ2"):
            cmd = './doLScan_massZ1_vs_massZ2.sh '+observableBins2[0]+' '+observableBins2[1]  # to be made auto w.r.t +opt.OBSBINS+
	print "the command for LScan is ......", cmd
        output = processCmd(cmd)

       # cmd = 'python plotLHScans.py -l -q -b --obsName='+obsName
        cmd = 'python plotLHScans.py -l -q -b --obsName="'+obsName+'" --obsBins="'+opt.OBSBINS+'" --obsName2="'+obsName2+'" --obsBins2="'+opt.OBSBINS2+'"' #+' --lumiscale=str(opt.LUMISCALE)'            
        output = processCmd(cmd)
        for modelName in modelNames:

            if (not opt.FIXMASS=="False"):
                #cmd = 'python producePlots.py -l -q -b --obsName="'+obsName+'" --obsBins="'+opt.OBSBINS+'" --unfoldModel="'+modelName+'" --theoryMass="'+opt.FIXMASS+'"'
                cmd = 'python producePlots.py -l -q -b --obsName="'+obsName+'" --obsBins="'+opt.OBSBINS+'" --unfoldModel="'+modelName+'" --theoryMass="'+opt.FIXMASS+'" --obsName2="'+obsName2+'" --obsBins2="'+opt.OBSBINS2+'"'
            else:
                #cmd = 'python producePlots.py -l -q -b --obsName="'+obsName+'" --obsBins="'+opt.OBSBINS+'" --unfoldModel="'+modelName+'" --theoryMass="125.0"'
                cmd = 'python producePlots.py -l -q -b --obsName="'+obsName+'" --obsBins="'+opt.OBSBINS+'" --unfoldModel="'+modelName+'" --theoryMass="125.0" --obsName2="'+obsName2+'" --obsBins2="'+opt.OBSBINS2+'"'
