...
def plotAsimov_sim(asimovDataModel, asimovPhysicalModel, modelName, physicalModel, obsName, fstate, observableBins, recobin, obsName2,observableBins2):
    ...
    print asimovDataModel+'_all_'+obsName+'_13TeV_Asimov_'+asimovPhysicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.root'
    #f_asimov = TFile(asimovDataModel+'_all_'+obsName+'_13TeV_Asimov_'+asimovPhysicalModel+'.root','READ')
    f_asimov = TFile(asimovDataModel+'_all_'+obsName+'_13TeV_Asimov_'+asimovPhysicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'.root','READ')
    ...
    print modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_result.root'
    #f_modelfit = TFile(modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_result.root','READ')
    f_modelfit = TFile(modelName+'_all_13TeV_xs_'+obsName+'_bin_'+physicalModel+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+'_result.root','READ')
...
# test
    latex2.DrawLatex(0.65,0.75, observableBins2[0]+".0 "+unit+" < "+label2+" < "+observableBins2[1]+".0 "+unit2)
    ...
    if (not opt.UNBLIND):
        ...
        c.SaveAs("plots/asimovdata_"+asimovDataModel+"_"+asimovPhysicalModel+"_unfoldwith_"+modelName+"_"+physicalModel+"_"+obsName+'_'+fstate+"_recobin"+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".pdf")
        ...
        c.SaveAs("plots/asimovdata_"+asimovDataModel+"_"+asimovPhysicalModel+"_unfoldwith_"+modelName+"_"+physicalModel+"_"+obsName+'_'+fstate+"_recobin"+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".png")
    else:
        #c.SaveAs("plots/data_unfoldwith_"+modelName+"_"+physicalModel+"_"+obsName+'_'+fstate+"_recobin"+str(recobin)+".pdf")
        c.SaveAs("plots/data_unfoldwith_"+modelName+"_"+physicalModel+"_"+obsName+'_'+fstate+"_recobin"+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".pdf")
        #c.SaveAs("plots/data_unfoldwith_"+modelName+"_"+physicalModel+"_"+obsName+'_'+fstate+"_recobin"+str(recobin)+".png")
        c.SaveAs("plots/data_unfoldwith_"+modelName+"_"+physicalModel+"_"+obsName+'_'+fstate+"_recobin"+str(recobin)+'_'+obsName2+'_'+observableBins2[0]+'_'+observableBins2[1]+".png")
...
for fState in fStates:
    for recobin in range(len(observableBins)-1):
        ...
        plotAsimov_sim(asimovDataModel, asimovPhysicalModel, modelName, physicalModel, obsName, fState, observableBins, recobin, obsName2,observableBins2)
